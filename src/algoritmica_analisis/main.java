...
public class main {
    ...
    public static void main(String[] args) {
        try {
            ...
            ParDePuntos resultado3 = Algoritmos.algoritmo_DyV(puntos);
            ParDePuntos resultado4 = Algoritmos.algoritmo_DyV_mejorado(puntos) ; 
            ...
            System.out.println("Par más cercano: " + resultado3);
            System.out.println("Distancia del par mas cercano: " + resultado3.getDistancia());
